...
app.get('/player_info/post', function(req,res){
  ...
  if(player_id != "Select Player"){
    ...
    var playerInfo = 'SELECT year,major,passing_yards,rushing_yards,receiving_yards, img_src FROM football_players WHERE id = ' + player_id + ';';
    var gameInfo = 'SELECT COUNT(*) FROM football_games LEFT OUTER JOIN football_players ON ARRAY[football_players.id] <@ football_games.players WHERE football_players.id = ' + player_id + ';';
